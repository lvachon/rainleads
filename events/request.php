...
loginRequired();
if($viewer->getAccount()->membership!="basic" && $viewer->getAccount()->membership!="pro"){die("Your account is unable to create or export events.  Please <a href='/account/upgrade.php'>upgrade</a> your account.");} 
$con = conDB();
$datestamp = time();
...
<div id="interior" style="width:410px;word-wrap:break-word; padding:5px;">
    <p><?=str_replace(array('%url','%post'),array($HOME_URL."events/sync-calendar.php?request=".$code,"<img src='{$HOME_URL}img/ical.png' style='width:380px;' />"),nl2br(cmsRead('RTFcalendar_export_blurb')))?>:</p><br />
</div>
