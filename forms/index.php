        ...
        <div id="contact_forms">
            ...
            <div class="contact_form_row">
                ...
                <div class="form_links">
                    ...
                    <div class="form_link button" onclick="document.location.href='formcode.php?id=<?=$f['id'];?>'"><img src="/img/embed-icon.png"><span><a href='formcode.php?id=<?=$f['id'];?>'>Embed Codes</a></span></div>
