...
<div id="content" class="inner">
    ...
    <div id="main" class="left">
    	<?php if(intval($_GET['form_id'])){?>
	    	<div class="right">                        	                     
	        	<a class="button blue_button" href='javascript:void()' onclick='$.get("../forms/showform.php?id=<?=$_GET['form_id'];?>&manual=1",function(data){$.fancybox(data);});'>Create Lead</a>
	        </div>
	    <?php }else{ ?>
	    	<div class="right">                        	                     
	        	<a class="button blue_button" href='javascript:void()' onclick='$.fancybox({"href":"../forms/pickform.php","type":"iframe","width":"320","height":"480"});'>Create Lead</a>
	        </div>
	    <?php } ?>
        <div id="recent_leads">
        	<?php
            ...
            $pgl = pageLinks($qry,$page,$per_page,"index.php?sort={$_GET['sort']}&filter={$_GET['filter']}&form_id={$_GET['form_id']}&delcon={$_GET['delcon']}");
            ...
            <div class="lead_row" >
                <table width="100%" cellpadding="5" cellspacing="0">
                    <tr valign="middle">
                        ...
                        <td onclick="document.location.href='lead.php?id=<?= $lead['id']; ?>'" valign="middle" class="star_cell" width="16" align="center"><img class="tip" title="Add to Pipeline" src="<?=$HOME_URL?>img/star-icon.png" /></td>
                        ...
                        <td valign="middle" align="" class="assign_cell" width="184">
                        	<?php if(in_array($viewer->id,$acct->admins)){?><div class='assign' id = 'assign<?=$lead['id'];?>' lead-id="<?=$lead['id'];?>" selected-text="<?=$tuser->name("F l");?>" selected-id="<?=$tuser->id;?>"></div><?php }else{ 
