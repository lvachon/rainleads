        ...
        <div id="lead_content">
                ...
                <div class="left">    
                    ...
                    <table class="lead_table" cellpadding="5">
                         <tr>
                            ...
                            <td class="lead_table_value"><?= $d['id'] ?></td>
                        </tr>
                        <tr>
            ...
            <div class="tab_content" data-tab="proposals" style="display:none;">
                ...
                <div id='proposal_list'>
                	...
                	while($prop = mysql_fetch_array($r)){$uux = new User($prop['user_id']);?>
                	   <div class="proposal">
                	   		<table cellpadding="5" width="100%">
                	   			...
                	   			<tr>
                	   				<td colspan="2"><img class="proposal_doctype" src="<?= $HOME_URL ?>img/doctypes/pdf.png" /> <a href="getfile.php?id=<?=$prop['id'];?>"><?=$prop['data'];?></a></td>
                		...
                		<input type='hidden' name='result_id' value='<?=$d['id'];?>' />
		                	...
		                	<div style="margin-left:80px; width:560px;">
                                ...
                                <div style="padding:5px 18px;">
                                    ...
                                    <div class='labelcell' >LinkedIn URL<div class='inputcell'><input type='text' placeholder="http://www.linkedin.com/in/" name='linkedin' value="<?=htmlentities($cdata['linkedin']);?>"/></div></div>
                                    </div>
                                    <div class="left" style="margin-right:5px;">
                                    <div class='labelcell' >Facebook URL<div class='inputcell'><input type='text' placeholder="http://www.facebook.com/" name='facebook' value="<?=htmlentities($cdata['facebook']);?>"/></div></div>
                                    </div>
                                    <div class="clear"></div>
                                    <br/>
                                    <div class="left" style="margin-right:5px;">
                                    <div class='labelcell' >Website URL<div class='inputcell'><input type='text' placeholder="http://" name='website' value="<?=htmlentities($cdata['website']);?>"/></div></div>
                                    </div>
                                    <div class="left" style="margin-right:5px;">
                                    <div class='labelcell' >Twitter<div class='inputcell'><input type='text' placeholder="@" name='twitter' value="<?=htmlentities($cdata['twitter']);?>"/></div></div>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
            ...
            <div class="tab_content" data-tab="events" style="display:none;">
                ...
                <div class="scrollbar1">
					...
					if(intval(mysql_num_rows($getUpcoming))){?>
                        ...
                        <?php while($e = mysql_fetch_array($getUpcoming)){
					...
					if(intval(mysql_num_rows($getPast))){?>
                    	<h5>Past Events</h5>
                    	<?php while($e = mysql_fetch_array($getPast)){
                            $event = new Event($e['id']);
                            include '../events/include.php';
                        }
					} ?>              
